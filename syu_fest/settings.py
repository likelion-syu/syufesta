"""
Django settings for syu_fest project.
...
SECRET_KEY = '7l!osp2q*#rrszk6*rtxjts_hib69vc9)h-*w^m$8t^#@vv8-h'
...
WSGI_APPLICATION = 'syu_fest.wsgi.application'
...
ACCOUNT_LOGOUT_REDIRECT_URL = '/festival'
